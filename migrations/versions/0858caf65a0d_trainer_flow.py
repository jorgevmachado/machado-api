...
def upgrade() -> None:
    ...
    op.create_table('owned_pokemons',
    ...
    op.create_table('trainer_encounters',
    sa.Column('trainer_id', sa.Uuid(), nullable=False),
    ...
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['pokemon_encounter_id'], ['encounters.id'], ),
    sa.ForeignKeyConstraint(['trainer_id'], ['trainers.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('owned_pokemon_moves',
    ...
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['owned_pokemon_id'], ['owned_pokemons.id'], ),
    sa.ForeignKeyConstraint(['pokemon_move_id'], ['moves.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['pokedex_id'], ['pokedex.id'], ),
    sa.ForeignKeyConstraint(['pokemon_id'], ['pokemons.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('trainer_parties',
    sa.Column('trainer_id', sa.Uuid(), nullable=False),
    ...
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['my_pokemon_id'], ['owned_pokemons.id'], ),
    sa.ForeignKeyConstraint(['trainer_id'], ['trainers.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
