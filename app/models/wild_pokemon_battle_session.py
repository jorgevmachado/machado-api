...
class WildPokemonBattleSession:
    __tablename__ = "wild_pokemon_battle_sessions"
    ...
    trainer: Mapped["Trainer"] = relationship(
        lazy=default_lazy,
        init=False,
        back_populates="wild_battle_sessions",
    )
    ...
    turns: Mapped[list["WildPokemonBattleTurn"]] = relationship(
        lazy=default_lazy,
        default_factory=list,
        init=False,
        repr=False,
    ...
    logs: Mapped[list["WildPokemonBattleLog"]] = relationship(
        lazy=default_lazy,
        default_factory=list,
        init=False,
        repr=False,
