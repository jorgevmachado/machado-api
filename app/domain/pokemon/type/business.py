...
TYPE_COLORS = [
    TypeColorSchema(id=1, name="ice", text_color="#fff", background_color="#51c4e7"),
    TypeColorSchema(id=2, name="bug", text_color="#b5d7a7", background_color="#482d53"),
    TypeColorSchema(id=3, name="fire", text_color="#fff", background_color="#fd7d24"),
    TypeColorSchema(id=4, name="rock", text_color="#fff", background_color="#a38c21"),
    TypeColorSchema(id=5, name="dark", text_color="#fff", background_color="#707070"),
    TypeColorSchema(id=6, name="steel", text_color="#fff", background_color="#9eb7b8"),
    TypeColorSchema(id=7, name="ghost", text_color="#fff", background_color="#7b62a3"),
    TypeColorSchema(
        id=8, name="fairy", text_color="#cb3fa0", background_color="#c8a2c8"
    ),
    TypeColorSchema(id=9, name="water", text_color="#fff", background_color="#4592c4"),
    TypeColorSchema(
        id=10, name="grass", text_color="#212121", background_color="#9bcc50"
    ),
    TypeColorSchema(id=11, name="normal", text_color="#000", background_color="#fff"),
    TypeColorSchema(
...
def ensure_colors(type_name: str | None = None) -> TypeColorSchema:
    default_type_color = TypeColorSchema(
        id=0,
...
def ensure_badges(
    ...
    default_type_badges = TypeBadgeSchema(
